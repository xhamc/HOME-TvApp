...
package com.sony.sel.util.ssdp;
...
public class SSDPSocket {
    ...
    SSDPSocket(InetAddress source, MulticastSocket mcSocket, DatagramSocket dgSocket)
        throws IOException {
        localInAddress = source;
    ...
    public void send(String data) throws IOException {
        DatagramPacket dp =
            new DatagramPacket(data.getBytes("UTF-8"), data.length(), mSSDPMulticastGroup);
    ...
    public boolean isConnected() {
        return wildSocket != null && mLocalSocket != null && wildSocket.isConnected() &&
            mLocalSocket.isConnected();
    }
